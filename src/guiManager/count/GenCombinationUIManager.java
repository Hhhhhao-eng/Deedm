 ...
 *
 */
public class GenCombinationUIManager extends JPanel {
	...
	public GenCombinationUIManager(PlainTextAreaManager plainManager, ImagedTextAreaManager imageManager) {
	...
	public boolean checkInput() {
		...
		String message = "C(" + baseSet.length() + ", " + length + ")";
		...
		feedbackAnimator.appendPlainStringToLastLine(" 开始生成组合 ");
	...
	private class SimpleListener implements ActionListener {
		...
		public boolean doCountString() {
			...
			Set baseSet = new Set(elements);
			String message = "C(" + baseSet.length() + ", " + length + ")";
			StringGenerator generator = new CombinationGenerator(elements, length);
			generator.first();
			...
			feedbackAnimator.appendPlainStringToLastLine("，从：");
			feedbackAnimator.appendLaTeXStringToLastLine(startString);
			feedbackAnimator.appendPlainStringToLastLine(" 开始输出组合 ");
			feedbackAnimator.appendLaTeXStringToLastLine(message);
			feedbackAnimator.appendPlainStringToLastLine(" 的 ");
			feedbackAnimator.appendLaTeXStringToLastLine("" + number);
			feedbackAnimator.appendPlainStringToLastLine(" 个串！");
			...
			imagedAreaManager.appendPlainStringToLastLine(" 开始输出组合 ");
			...
			textAreaManager.appendContent("\tThere are " + totalCounter + " string(s) for " + length + " combinations on the set B (element number = " + baseSet.length() + ")\n");
			...
			imagedAreaManager.appendPlainStringToLastLine(" 组合总共有 ");
